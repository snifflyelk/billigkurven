...
```env
# Valgfri: sett et tak. Hvis ikke satt, synkes alle synkbare produkter.
LIVE_PRICING_MAX_PRODUCTS=
LIVE_PRICING_MIN_INTERVAL_HOURS=6
LIVE_PRICING_ENABLE_CATALOG_DISCOVERY=true
LIVE_PRICING_DISCOVERY_MAX_CANDIDATES_PER_PROVIDER=8000
LIVE_PRICING_DISCOVERY_QUERIES=
LIVE_PRICING_ODA_SEARCH_PAGES=80
LIVE_PRICING_NG_SEARCH_PAGES=80
LIVE_PRICING_NG_PAGE_SIZE=250
